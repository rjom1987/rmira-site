...
(function () {
  ...
  function buildPreferencesModal() {
    var body = ''
      ...
      + '<p>Cookies técnicos eventualmente definidos pela infraestrutura de segurança (proteção contra tráfego '
      + 'malicioso) podem ocorrer na camada de rede, fora do controle do conteúdo do site. Não requerem '
      + 'consentimento por serem indispensáveis à prestação do serviço. <em>[A confirmar — depende da configuração ativa de segurança do domínio.]</em></p>'
      + '</div>'
      + '<div class="rmira-prefs-item">'
